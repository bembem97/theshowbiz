    ...
    <div>
      <Accordion defaultValue={["previous"]}>
        <AccordionItem value="upcoming">
          ...
          <AccordionContent className="**:[a]:no-underline **:[a]:underline-offset-0">
            {credits !== undefined ? (
              <ul>
              ...
              <Alert>
                <AlertDescription>No upcoming projects</AlertDescription>
              </Alert>
            )}
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="previous">
          ...
          <AccordionContent className="**:[a]:no-underline **:[a]:underline-offset-0">
            {credits !== undefined ? (
              ...
              <Alert>
                <AlertDescription>No projects</AlertDescription>
              </Alert>
            )}
          </AccordionContent>
        </AccordionItem>
          ...
          >
            ...
            <ItemContent className="gap-y-0">
              ...
              <div className="flex h-5 items-center gap-x-1">
                <ItemDescription className="mb-0! pr-1">{role}</ItemDescription>
